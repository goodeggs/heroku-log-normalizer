...
describe 'logdrain gateway', ->
  ...
  describe 'a logfmt log with explicit options', ->
    ...
    beforeEach ->
      logdrainGateway.write '{"name":"status","appInstance":"production"}!Dec 18 00:50:48 23.20.136.26 485 <13>1 2013-12-18T00:50:49.194368+00:00 d.1077786c-2728-483f-911f-89a0ef249867 heroku router - - sample#memory_total=190.64MB\n'
